            ...
            function extractGarantiTable() {
                ...
                for (var t = 0; t < tables.length; t++) {
                    ...
                    for (var r = 1; r < rows.length; r++) {
                        ...
                        // Fallback duration parsing for Garanti's "32-45 Gün" format
                        if (!durParsed) {
                    ...
                    if (tableRows.length >= 1) {
                        Android.sendRateWithTable(0, 'Hoş Geldin Faizi', 'Garanti BBVA', JSON.stringify({headers: headers, rows: tableRows}));
                        return true;
                    }
                }
                return false;
